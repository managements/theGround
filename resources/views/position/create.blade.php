    ...
    <div class="content container-fluid">
        <div class="row">
            <div class="card-box">
                ...
                {{ Form::open(['method' => 'POST', 'url' => route('position.store',$company),'class' => 'form-horizontal']) }}
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-md-6">
                                        {{ Form::text('position',null,['class' => 'form-control', 'placeholder'=> 'position','required','minlenght' => '3','maxlenght'=> '15']) }}
                                    ...
                                    <div class="col-md-6">
                                        {{ Form::email('email',null,['class' => 'form-control', 'placeholder'=> 'email','minlenght' => '3','maxlenght'=> '15']) }}
                                        @if($errors->has('email'))
                                            <div class="row">
                                                <div class="col-xs-12">
