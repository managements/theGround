    ...
    <div class="content container-fluid">
        <div class="row">
            <div class="card-box">
                ...
                <?php $slug = $deal->slug ?>
                {{ Form::model($deal,['method' => 'PUT', 'url' => route('provider.update', compact('company','slug')),'class' => 'form-horizontal']) }}
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <select name="city" id="city" class="form-control" required>
                                    @foreach(\App\City::all() as $city)
                                        <option value="{{ $city->id }}" {{ ($deal->city_id == $city->id) ? 'selected' :'' }}>{{ $city->city }}</option>
                                    @endforeach
                                </select>
                                @if($errors->has('city'))
